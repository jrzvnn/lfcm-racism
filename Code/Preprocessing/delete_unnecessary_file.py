...
directory_path = "/home/jrzvnn/Documents/Projects/lfcm-racism/Data/Raw_Data/conversation_tweets"

# Define the file pattern to keep
file_pattern = "conversationthread-*.json"
...
def delete_files_not_matching_pattern(directory_path, file_pattern):
    ...
    for root, dirs, files in os.walk(directory_path):
        for file in files:
            ...
            if not file.startswith("conversationthread-") or not file.endswith(".json"):
                # Delete the file
                os.remove(file_path)
